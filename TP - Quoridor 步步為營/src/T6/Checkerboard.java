...
//		GameStart = true;
//		if(x < deviation || y < deviation || x > 720 || y > 720) {
//			if(AnnotationSwitch) {
//				System.out.println("Out of bounds"); //出界
//			}
//		}else {
...
//	-------------------------------------------------------------------------------------------------------------------------
	 ...
	 * 設定玩家人數
	 * */
	public void setNumberOfPlayers(int total) {
		this.NumberOfPlayers =  total;
...
//		System.out.println("updataCheckerboard -> Checkerboard");
//		for(int i = 0;i<Checkerboard.length;i++) {
