...
//	修改 ----------------------------------------------------------------------------------
	public Console(int panelWidth, Quoridor quoridor) {
	...
	private void init() {
		...
		panel_inAboveHeight = 50;
		
		panel_inBelowHeight = 30;
...
//				checkerboard.updataCheckerboard(quoridor.getCheckerboard(), true);
